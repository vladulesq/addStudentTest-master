package addStudentTest.console;
...
public class UI {
    ...
    public void uiSaveStudent() {
        ...
        scanner.nextLine(); // scanner.nextInt() does not read the \n character
        ...
        if (service.saveStudent(id, nume, grupa)) {
    ...
    public void uiSaveTema() {
        ...
        if (service.saveTema(id, descriere, deadline, startline)) {
