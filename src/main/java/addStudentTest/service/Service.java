package addStudentTest.service;

import addStudentTest.domain.*;
import addStudentTest.repository.*;
...
public class Service {
    ...
    public boolean saveStudent(int id, String nume, int grupa) {
    ...
    public boolean saveTema(String id, String descriere, int deadline, int startline) {
    ...
    public int saveNota(int idStudent, String idTema, double valNota, int predata, String feedback) {
    ...
    public int updateStudent(int id, String numeNou, int grupaNoua) {
    ...
    public void createStudentFile(int idStudent, String idTema) {
